...
Model.prototype.refreshAttributes = function() {
  ...
  var _attributes = this.Instance.prototype.attributes = Object.keys(this.Instance.prototype.rawAttributes);
  this.Instance.prototype._isAttribute = Utils._.memoize(function(key) {
    // TODO attribute的不知道什么时候被清空了
    var attributes = self.Instance.prototype.attributes || _attributes || [];
