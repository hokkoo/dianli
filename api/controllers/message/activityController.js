...
module.exports = {
    list : function(req,res,next) {
        var Activity = sails.sequelize['message.activity'];
        var params = req.allParams(), where = {};
        var param = params.param || {};
        Activity.findAndCount({
            where: where,
            limit: params.take,
            offset: params.start
        }).then(function (data) {
    ...
    images : function(req,res,next) {
        ...
        var params = req.allParams(), where = {};
        where['type'] = _type.message.activity;
        var param = params.param || {};
    ...
    delete : function(req,res,next) {
        ...
        if(params.id){
            ...
            var item = Activity.build({id: params.id}, {isNewRecord: false, raw: true});
