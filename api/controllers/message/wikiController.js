...
module.exports = {
    list : function(req,res,next) {
        var Wiki = sails.sequelize['message.wiki'];
    ...
    delete : function(req,res,next) {
        ...
        if(params.id){
            ...
            var item = Wiki.build({id: params.id}, {isNewRecord: false, raw: true});
    ...
    addImage: function(req,res,next) {
        ...
        var params = req.allParams(), where;
        params = params.item || {};
        params.type = _type.message.wiki;
